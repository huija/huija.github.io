...
#### 直接部署
> 假设你已经看过了[MongoDB入门](https://huija.github.io/mongodb-starter/), 那么下面的复制集部署其实并不难
...
除了上述5个选项, 也可以给mongod进程打tag, 然后设置tag, 指定读取偏好, 类似K8S的Pod调度, MongoDB在驱动层实现了节点选择算法.
